...
const VideoSection = ({ 
  ...
  return (
    <div className="flex-1 relative w-full h-full aspect-video bg-gray-800 overflow-hidden">
      ...
      <div className="absolute top-4 right-4 w-28 h-20 sm:w-36 sm:h-28 md:w-47 md:h-34 bg-gray-700 rounded-lg border-2 border-gray-600 flex items-center justify-center p-2">
        <div className="text-center">
          <img
