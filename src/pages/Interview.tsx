...
//   useEffect(() => {
//     // Cleanup on unmount: stop media, clear intervals, stop AI interview
//     return () => {
//       if (mediaStream) mediaStream.getTracks().forEach(track => track.stop());
//       if (durationInterval.current) clearInterval(durationInterval.current);
//       window.speechSynthesis.cancel();
//       stopListening();
//       stopInterview(); // <-- This will stop the AI interview session if active
//     };
//   }, []);
...
//       durationInterval.current = setInterval(() => setDuration(prev => prev + 1), 2000);
...
// const INSTRUCTIONS = [
//   "Make sure your camera and mic are enabled.",
//   "AI will begin with asking your name.",
//   "You can answer by voice or by typing.",
//   "Wait until AI finishes speaking before responding.",
//   "Switch language before starting if needed.",
//   "Click 'End Interview' when done.",
//   "AI feedback will be shown after interview.",
//   "Ensure you are in a quiet environment for best results.",
//   "Speak clearly and at a moderate pace.",
//   "Avoid refreshing the page during the interview.",
//   "Keep your face visible to the camera at all times.",
//   "Ensure a stable internet connection to prevent disruptions.",
//   "If mic doesn't work, switch to text input temporarily.",
 
//   "Interview will be automatically saved for future review."
// ];


//   return (
//     <div className="min-h-screen bg-gradient-to-br from-[#15192c] via-[#232d4d] to-[#20202b] flex flex-col items-center justify-start">
...
//           </button>
//           <div className="flex-1 text-xl text-red-500 font-bold">
...
//         <div className="flex-[2.8] flex flex-col rounded-2xl bg-black/30 overflow-hidden min-h-[340px]">

//           {/* Add challenge/role description here */}
//           {roleDescription && (
...
//           <form onSubmit={handleTextSubmit} className="flex items-center gap-2 p-3 border-t border-gray-700 bg-gray-900">
//             <Input
//               type="text"
...
//         <div className="w-full md:w-[480px] rounded-2xl bg-black/30">
...
//           <div className="bg-yellow-50 border-l-4 border-yellow-400 rounded-lg shadow p-4 h-auto  flex flex-col justify-start">
...
// Interview.tsx (updated responsive and dropdown fix version)
import { useState, useEffect, useRef } from 'react';
import { useParams, useLocation, useNavigate } from 'react-router-dom';
import { doc, updateDoc, setDoc } from 'firebase/firestore';
import { db } from '@/lib/firebase';
...
const Interview = () => {
 ...
 const INSTRUCTIONS = [
  ...
  "Click 'End Interview' once you are finished.",
